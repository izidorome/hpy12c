...
def test_nper_when_interest_rate_is_zero():
    ...
    results = py12c.nper(0.0, -100.0, 1000.0)
...
def test_nper_when_interest_rate_is_zero_with_fv():
    ...
    results = py12c.nper(0.0, -100.0, 1000.0, -200.00)
